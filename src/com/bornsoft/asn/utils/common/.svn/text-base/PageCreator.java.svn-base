	...
	public String getPageBar(){
	 ...
	 private String getLeftBar(){
	     ...
	     if (currentPage == 1) {
	    	 leftString = new StringBuffer("");
                     ...
                     //修改<< 为 "上一页" by hooxin 
	    	 leftString = new StringBuffer( "<a href=\"JavaScript:;\" onclick=\'JavaScript:document.getElementById(\"thePage\").value="+(getCurrentPage() - 1)+";document.getElementById(\"pageButton\").click();return false;\'>上一页</a>");
	     }
	 ...
	 private String getRightBar(){
	     ...
	     if (currentPage == totalPage) {
	    	 ...
	    	 rightString = new StringBuffer( "<a href=\"JavaScript:;\" onclick=\'JavaScript:document.getElementById(\"thePage\").value="+(getCurrentPage() + 1)+";document.getElementById(\"pageButton\").click();return false;\'>下一页</a>");
	     }
		 ...
		 if (totalPage <= lineCursor){
			  for(int i=1;i<=this.totalPage;i++){
				  if (i == this.currentPage) {
					  ...
					  centerString.append("<a href=\"JavaScript:;\" onclick=\'JavaScript:document.getElementById(\"thePage\").value="+i+";document.getElementById(\"pageButton\").click();return false;\'>"+i+"</a>");
				  }
			  }
		 }else{
	 ...
	 private String getHidden(){
		 return "<input type=\"hidden\" name=\"page\" id=\"thePage\"/><input type=\"button\" id=\"pageButton\" style=\"display: none;\" onclick=\"JavaScript:this.form.submit()\"/><input type=\"hidden\" id=\"totalPage\" value="+totalPage+" />";
	 }
