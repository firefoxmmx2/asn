...
$(document).ready(function(){
    ...
    <table align="center" width="790" cellpadding="0" cellspacing="0">
		...
		<form action="<%=cp%>/admin/advert/updateAdvert" method="post" name="form1" id="form1" enctype="multipart/form-data">
          <input type="hidden" name="advert.advertId" id="advertId" value="<%=adv.getAdvertId() %>" />
          <table align="center" width="790"cellpadding="0" cellspacing="0" border="1" bordercolor="#CCCCCC" style="padding-top:10px; border-collapse:collapse;">			
			<tr>
	            ...
	            <td>&nbsp;<input name="advert.advName" type="text" id="advName" size="50" value="<%=adv.getAdvName()%>" /><span id="errorsDiv_advert.advName"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right"><font color="red">*</font>广告类型：</td>
	            <td>&nbsp;<input name="advert.advType" type="text" id="advType" size="20" value="<%=adv.getAdvType()%>" /><span id="errorsDiv_advert.advType"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right"><font color="red">*</font>广告地址：</td>
	            <td>&nbsp;<input name="advert.advAddress" type="text" id="advAddress" size="50" value="<%=adv.getAdvAddress()%>" /><span id="errorsDiv_advert.advAddress"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right"><font color="red">*</font>广告规格：</td>
	            <td>&nbsp;<input name="advert.advSpec" type="text" id="advSpec" size="20" value="<%=adv.getAdvSpec()%>" /><span id="errorsDiv_advert.advSpec"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right"><font color="red">*</font>所需价格：</td>
	            <td>&nbsp;<input name="advert.quote" type="text" id="quote" size="12" maxlength="10" value="<%=adv.getQuote().intValue()%>" />
			...
			<tr>     
	            ...
	            <td>&nbsp;<input type="file" name="advertPic" size="50" id="advertPic"/><br> 
	            	<img alt="" src="<%=request.getContextPath()%><%=adv.getPicPath()%>" width="80" height="80">
			...
			<tr>
	            ...
	            <td>&nbsp;<input name="advert.startTime" type="text" id="startTime" size="20" readonly="readonly" value="<%=new SimpleDateFormat("yyyy-MM-dd ").format(adv.getStartTime())%>" onclick="SelectDate(this,'yyyy-MM-dd');" /><span id="errorsDiv_advert.startTime"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right"><font color="red">*</font>结束时间：</td>
	            <td>&nbsp;<input name="advert.endTime" type="text" id="endTime" size="20" readonly="readonly" value="<%=new SimpleDateFormat("yyyy-MM-dd ").format(adv.getEndTime())%>" onclick="SelectDate(this,'yyyy-MM-dd');"/><span id="errorsDiv_advert.endTime"></span></td>          	
			</tr>
			
			<tr>
				<td height="40" width="90" align="right">描述：</td>
	            <td height="150">&nbsp;
	            	<textarea cols="60" rows="6" name="advert.description" id="description"><%=Str.get(adv.getDescription())%></textarea>
	            </td>          	
			</tr>
           ...
           <table align="center" width="790"cellpadding="0" cellspacing="0" >		
			<tr>			
		        ...
		        <font color="red"><strong><%= request.getAttribute("advert_msg") == null?"":"修改成功" %></strong></font>
	            </td>          	
			</tr>		
			</table>
