...
<html>
	<head>
		...
		<script type="text/javascript">
			function reset(){
				document.location="<%=cp%>/admin/ck/toCensorTable";
			}
		</script>
	</head>
	<body>
		...
		<div style="width: 790px;">
			<s:form action="/admin/ck/updateCensorword" method="post" theme="simple">
				<div>
				<textarea rows="20" cols="96" name="censorword"><s:property value="censorword"/></textarea>
				</div>
