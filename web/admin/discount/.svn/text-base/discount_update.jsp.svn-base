...
<body>
		...
		<tr>
			<td height="39" class="title">修改折扣活动</td>			
		</tr>
		</table>
		
		          
          <form action="../discount/updateAdminDiscount" method="post" name="form1" id="form1">
          <input type="hidden" name="discountbean.activityId" id="activityId" value="<%=d.getActivityId() %>">
          <table align="center" width="790"cellpadding="0" cellspacing="0" border="1" bordercolor="#CCCCCC" style="padding-top:10px; border-collapse:collapse;">			
			<tr>
	            ...
	            <td>&nbsp;<input name="discountbean.discountName" type="text" id="discountName" size="50" value="<%=d.getDiscountName() %>" /><span id="errorsDiv_discountbean.discountName"></span></td>          	
			</tr>
			<tr>
				<td height="40" align="right"><font color="red">*</font>开始日期：</td>
	            <td>&nbsp;<input name="discountbean.beginDate" type="text" id="beginDate" value="<%=d.getBeginTime().toString().substring(0,10).replace("-",".") %>" />时间
                  	  <input name="discountbean.beginTime" type="text" id="beginTime" size="10" value="<%=d.getBeginTime().toString().substring(11,16) %>" />(时间如：15:30)
			...
			<tr>
	            ...
	            <td>&nbsp;<input name="discountbean.endDate" type="text" id="endDate" value="<%=d.getEndTime().toString().substring(0,10).replace("-",".") %>" />时间
                  	  <input name="discountbean.endTime" type="text" id="endTime" size="10" value="<%=d.getEndTime().toString().substring(11,16) %>" />(时间如：15:30)
			...
			<tr>
	            ...
	            <td>&nbsp;
	        		<table> 
	        			<tr>
	        				<td><textarea cols="40" rows="5" name="discountbean.discountType" id="discountType"><%=d.getDiscountType() %></textarea><br><span id="errorsDiv_discountbean.discountType"></span></td>
