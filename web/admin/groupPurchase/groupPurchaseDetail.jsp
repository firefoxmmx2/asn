...
<script type="text/javascript" src="groupPurchaseDetail.js"></script>
	...
	<table align="center" width="792" height="51" cellpadding="0"
		...
		<tr>
					...
					<tr>
						...
						<td align="center" valign="middle"><s:iterator
							...
							<s:if test="#s.index != details.size-1">
								<div style="border-bottom: 1px #e3e3e3 solid;" class="a1">
							</s:if>
							<s:else>
								<div>
							</s:else>
			...
			<table width="790" border="0" align="center" cellspacing="1"
				...
				<tr>
					<td align="left" height="40"><input type="button" value="使有效"
						class="sm-buttom4-2" id="validBtn"> <input type="button"
						value="使无效" class="sm-buttom5-2" id="invalidBtn"> <input
						type="button" value="返回" class="sm-buttom5-2" id="backBtn">
					</td>
				</tr>
			</table>
