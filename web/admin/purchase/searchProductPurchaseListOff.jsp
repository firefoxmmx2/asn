			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2"  align="center" class="list" >
				...
				<s:iterator id="item" value="listPP" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>'>
						...
						<td class="zuo">&nbsp;<input type="button" value="修改" class="button2" onclick="doRedirect('purchase/toUpdateProductPurchase?purchaseId=<s:property value="#item.purchaseId"></s:property>')"></input>&nbsp;</td>
					</tr>
				<%
				looprow ++; 
				%>
				...
				<tr>
					...
					&nbsp;&nbsp;<input type="button" value="取消发布" class="button5" onclick="submitSelectBox('setProductPurchaseOn?purchaseIds=')"></input>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="button5" value="永久删除" onclick="submitSelectBoxDel('setProductPurchaseDel?purchaseIds=')"></input>
					</td>
					<td colspan="5">&nbsp;</td>
				</tr>
			</table>
