...
<html>
	...
	<body>
		...
		<s:form action="searchProductPurchaseListOn">
		<tr>
		...
		<tr>
			<td nowrap colspan="3">&nbsp;&nbsp;<label><input type="radio" id="a" checked onclick="javascript:productOn();" class="frmrd"/>已发布上网</label>&nbsp;&nbsp;&nbsp;<label><input type="radio" id="a" onclick="javascript:productOff();" class="frmrd"/>已取消发布</label>
			</td>
		</tr>
		</s:form>
		<script type="text/javascript">
		...
		<div>
			<table width="100%" border="0" cellspacing="1" cellpadding="2"  align="center" class="list" >
				...
				<tr>
					<td><input type="checkbox" class="frmrd" id="allSelect" value="selectAll" onclick="checkAll()">全选</input>
					&nbsp;&nbsp;<input type="button" value="取消发布" class="button5" onclick="submitSelectBox('setProductPurchaseOff?purchaseIds=')"></input>
					</td>
					<td>&nbsp;</td>
				</tr>
			</table>
