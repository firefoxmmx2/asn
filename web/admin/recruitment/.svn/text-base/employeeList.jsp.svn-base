...
<script type="text/javascript">
		...
		function delSelectBox(url,jid){
			...
			if(r==true){
				window.location.href=url+"?ids="+ids+"&jid="+jid;
			}
		}
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
				  <tr>
                      ...
                      <td width="116" align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="JavaScript:;" onclick="doRedirect('')">备选列表</a></td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" class="list" >
				...
				<s:iterator id="item" value="employeeList" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>' height="50">
						...
						<td class="zuo" style="text-align: center;"><a target="_blank" href="#"><s:property value="#item.name"></s:property></a></td>
						...
						<a href="showEmployee?eid=<s:property value="#item.id"/>" target="_blank">详情</a>
						<a href="deleteEmployee?ids=<s:property value="#item.id" />&jid=${jobId}" onclick="return confirm('确定要删除该应聘信息吗？')">删除</a>
						</td>
					</tr>
				<%
				looprow ++;
				...
				<tr>
					...
					&nbsp;&nbsp;
					<input type="button" value="删除" class="button5" onclick="delSelectBox('deleteEmployee','${jobId}')"></input>
					</td>
					<td colspan="2"></td>
				</tr>
