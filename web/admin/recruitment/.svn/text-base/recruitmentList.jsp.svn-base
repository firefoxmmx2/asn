	...
	<table align="center" width="790" height="45" bgcolor="#fffced" cellpadding="0" cellspacing="0"  class="sm-ts">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
				  ...
				  <tr>
                      ...
                      <td width="116"  align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="JavaScript:;" onclick="doRedirect('toRecruitmentList?status=1')">已发布上网</a></td>
					  ...
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
                      <td width="116" align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="JavaScript:;" onclick="doRedirect('toRecruitmentList?status=3')">草稿箱</a></td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
				  ...
				  <tr>
                      ...
                      <td width="116"  align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="JavaScript:;" onclick="doRedirect('toRecruitmentList?status=1')">已发布上网</a></td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
                      <td width="116" align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="JavaScript:;" onclick="doRedirect('toRecruitmentList?status=2')">已取消发布</a></td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
		...
		<div>
			<table width="790" border="0" cellspacing="0" cellpadding="0"  align="center" class="list" >
				<tr class="head" style="text-align: center;font: 14px solid bold;">
					<td class="libiaobg" nowrap></td> 
					<td class="libiaobg" nowrap width="30%">职位名称d</td>
				...
				<s:iterator id="item" value="recruitmentList" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>' height="50">
						...
						<td class="zuo" style="text-align: center;"><a target="_blank" href="#"><s:property value="#item.jobName"></s:property></a></td>
						...
						<td class="zuo" align="center">
						<a href="toEmployeeList?jid=<s:property value="#item.id" />" target="_blank">应聘简历列表</a>
						</td>
					</tr>
				<%
				looprow ++;
