...
<body>
	...
	<br>
	<s:form action="createRecruitment" method="post"  theme="simple" namespace="/admin/recr" id="form1">
            	...
            	<tr>
                 	<td height="40">&nbsp;</td>
	              	<td><input type="submit" value="发布" />&nbsp;
	              		...
	              		<input type="button" value="保存为草稿" onclick="JavaScript:document.getElementById('status').value='3';this.form.submit()"/>
	              	</td>
	        	</tr>  
		</table>	
	</s:form>
