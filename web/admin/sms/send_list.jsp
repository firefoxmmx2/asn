...
function optAdvert(){
	...
	if(value == ""){
		...
		if(confirm("你确定要向这些用户发送信息！")){
			location.href="<%=cp%>/admin/sms/RepeatSend?id="+value;
		}
	}
...
//-->
    ...
    <s:form action="listSend" name="myform" id="myform" method="post">
	<table align="center" width="792" height="51" cellpadding="0" cellspacing="0">
   	<tr>
         <td height="39" class="title">发件箱</td>
   	</tr>  
	<tr>
		<td class="boder_y">
          ...
          <tr>
            ...
            <td width="300">
            	...
            	<s:select list="#{'':'短信状态','N':'等待发送','Y':'已发送成功','E':'发送失败'}" name="smsSend.smsStatus" id="smsStatus"></s:select>&nbsp;
          ...
          <tr>
            ...
            <td align="left" width="100"><img src="../../image/comdo/button_qd.gif" width="50" height="25" onClick="myform.action='listSend?pageType=sub';myform.submit();" style="cursor:pointer;" /></td>
          </tr>
        </table>
		</td>
	</tr>
	    ...
	    <td>
		    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;" class="table_border">
                   <tr>
						...
						<td height="28" align="center" bgcolor="#e8f5fb" width="80">短信状态</td>
                 ...
                 <tr>
					...
					<td align="center"><%=send.getSmsStatus().equals("N")?"<font color=blue>等待发送</font>":send.getSmsStatus().equals("Y")?"<font color=green>已发送成功</font>":send.getSmsStatus().equals("E")?"<font color=red>发送失败</font>":"" %></td>
		  ...
		  <table width="790" border="0" align="center" cellspacing="1" cellpadding="2" style="border-top:1px #6cbc48 solid;">
			<tr>
				<td align="left" height="40">
					<input type="button" value="批量重发" onclick="optAdvert()" class="sm-buttom4-2" >
				</td>		
			</tr>
		</table>
