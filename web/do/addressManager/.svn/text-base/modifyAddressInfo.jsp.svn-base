...
<script type="text/javascript">	
		...
		$(document).ready(function(){
			geoloc.init("divArea","- 不限省市 -", "- 不限地州市 -", "- 不限区县 -", "area",$("#oldAreaCode").val());
		});
...
<body>
  ...
  <form id="form1" name="form1" method="post"  action="updateAddressInfo.action" enctype="multipart/form-data">
     <s:hidden name="address.areaCode" id="oldAreaCode"/>
     <input type="hidden" name="addId" value="<s:property value="address.id"/>">
	...
	<table align="center" width="790" height="40" cellpadding="0" cellspacing="0" style="padding-top:10px;">
		<tr>
			<td width="5">&nbsp;</td>
			<td width="785" class="sm-title">修改收货地址 </td>			
		</tr>
	</table>
	...
	<table align="center" width="790"cellpadding="0" cellspacing="0" border="1" bordercolor="#CCCCCC" style="padding-top:10px; border-collapse:collapse;">		
		...
		<tr>
            ...
            <td width="520">&nbsp;
               <input type="text" name="drawerName" value='<s:property value="address.drawerName"/>'/>
			</td>
			<td>
			    &nbsp;
			</td>       	
		...
		<tr>
            ...
            <td>&nbsp;
               <textarea cols="60" rows="3" name="detailAddress">
                 <s:property value="address.detailAddress" />
               </textarea>
               <br>
		...
		<tr>
			<td height="30" width="90" align="right">邮政编码：<em class="red">*</em>&nbsp; </td>
            <td>&nbsp;
                <input type="text" size="40" name="zipCode"  value="<s:property value="address.zipCode"/>" />
            </td>
            <td>
			    &nbsp;
			</td>          	
		...
		<tr>
			<td height="30" width="90" align="right">电话号码：<em class="red">*</em>&nbsp; </td>
            <td>&nbsp;
                <input type="text" size="40" name="drawerNumber" value="<s:property value="address.drawerNumber"/>" />
            </td>
            <td>
			    &nbsp;
			</td>           	
	    ...
	    <tr>
			<td height="30" width="90" align="right">移动号码：<em class="red">*</em>&nbsp; </td>
            <td>&nbsp;
                <input type="text" size="40" name="mobileNumber" value="<s:property value="address.mobileNumber"/>" />
            </td>
            <td>
			    &nbsp;
			</td>           	
