...
function operationMember(val,operation){
	...
	<s:form action="listMemberByParam" name="myform" id="myform">
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:20px;" class="table_border">
				...
				%>
			  	<tr>
					...
					<td>&nbsp;<a href="<%=cp%>/admin/member/getMemberById?id=<%=m.getMemberId() %>"><%=f.n2s(m.getSsoAccount())%></a>
					...
					<td width="200">&nbsp;<%=f.n2s(f.areaName(m.getArea()))%></td>
		  ...
		  <table width="790" border="0" align="center" cellspacing="1" cellpadding="2" style="border-top:1px #6cbc48 solid;">
			<tr>
			  <td align="left" height="40">
					...
					<input type="button" value="恢复" onClick="operationMember('Unlocked','unlock')" class="sm-buttom2-2" ></td>		
			</tr>
		</table>
