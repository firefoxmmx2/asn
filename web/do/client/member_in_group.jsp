...
<table width="100%">
			<tr>
				<td width="20%" valign="top"><iframe src="<%=cp%>/do/client/groupChoose"  id="groupChoose" name="groupChoose" align="MIDDLE" width="100%" height="425" marginwidth="1" marginheight="1" frameborder="none" style="margin-top:1;"  scrolling="YES"></iframe></td>
				<td id="td1" valign="top" width="80%"><iframe src="<%=cp%>/do/client/getUnGroupedMember"  id="groupMember" name="groupMember" align="MIDDLE" width="100%" height="425" marginwidth="1" marginheight="1" frameborder="none" style="margin-top:1;"  scrolling="YES"></iframe></td>
			</tr>
		</table>
</form>
