...
<body>
	...
	<br>
	<s:form action="/do/customer/bizOpp/modifySaleSource" method="post" id="form1" enctype="multipart/form-data">
		<input type="hidden" value="${saleSource.id}" name="saleSource.id"></input>
		<input type="hidden" value="${saleSource.fileName}" name="saleSource.fileName"></input>
		<input type="hidden" value="${saleSource.fileId}" name="saleSource.fileId"></input>
		<table width="90%" align="center" cellpadding="0" cellspacing="0">
			<tr>
            	<td height="30" class="wz_left" ><span style="color:red;">*</span>销售信息标题：</td>
                <td><input type="text" name="saleSource.title" size="38" value="${saleSource.title}"></input><span id="errorsDiv_saleSource.title"></span></td>
            </tr>
            <tr>
	            <td height="30" class="wz_left" ><span style="color:red;">*</span>销售资料：</td>
	            <td>
	            <textarea name="saleSource.source" rows="15" cols="60">${saleSource.source}</textarea>
           	...
           	<tr>
                ...
                <td>
                <textarea name="saleSource.proce" rows="15" cols="60">${saleSource.proce}</textarea>
                </td>
            </tr>
            <tr>
            	<td height="30" class="wz_left" >现有附件：</td>
                <td>
                	<s:if test="saleSource.fileId!=null">
                		<s:property value="saleSource.fileName"></s:property>
                	</s:if>
                	<s:else>
                		暂无
                	</s:else>
            ...
            <tr>
            	<td height="30" class="wz_left" >更换附件：</td>
                <td>
