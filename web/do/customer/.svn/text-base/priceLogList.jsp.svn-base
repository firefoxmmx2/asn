	...
	<s:if test="listppl.size()>=1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" class="list" >
				<tr class="head">
					...
					<td class="libiaobg" nowrap width="10%" align="center">原价格1</td>
					<td class="libiaobg" nowrap width="10%" align="center">现价格1</td>
					<td class="libiaobg" nowrap width="10%" align="center">原价格2</td>
					<td class="libiaobg" nowrap width="10%" align="center">现价格2</td>
					<td class="libiaobg" nowrap width="10%" align="center">原价格3</td>
					<td class="libiaobg" nowrap width="10%" align="center">现价格3</td>
				</tr>
				
				<%
				int looprow = 0;
				%>
				<s:iterator id="item" value="listppl" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>' height="50">
						...
						<td class="zuo" align="center"><s:property value="#item.oldPrice1"/></td>
						<td class="zuo" align="center"><s:property value="#item.newPrice1"/></td>
						<td class="zuo" align="center"><s:property value="#item.oldPrice2"/></td>
						<td class="zuo" align="center"><s:property value="#item.newPrice2"/></td>
						<td class="zuo" align="center"><s:property value="#item.oldPrice3"/></td>
						<td class="zuo" align="center"><s:property value="#item.newPrice3"/></td>  
					</tr>
				<%
				looprow ++;
				%>
