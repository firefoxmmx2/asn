...
-->
	...
	<table align="center" width="792" height="39" cellpadding="0" cellspacing="0">
	   	<tr>
	         <td height="39" class="title">客户满意度分析</td>
	   	</tr> 
	</table>    
	
	
	<form action="<%=request.getContextPath()%>/do/customer/statistics/satisfaction" method="post" name="myform">
		...
		<tr>
			<td><table width="500">
					...
					<tr>
						...
						<img src="<%=request.getContextPath()%>/image/comdo/button_qd.gif" width="50" height="25" onClick="myform.action='satisfaction';myform.submit();" style="cursor:pointer;" /></td>					
					</tr>
				</table>	
			</td>
		</tr>	
	...
	<table width="792" border="0" cellspacing="0" height="33" cellpadding="0" style="margin-top:20px;background: url('<%=request.getContextPath()%>/image/hzx/change_bg.gif') repeat-x;" >
			<tr>
				<td width="20">&nbsp;</td>
				<td class="customerChange1" align="center" width="127"><a href="<%=request.getContextPath()%>/do/customer/statistics/consumerTop?statisticsType=order">客户满意度分析</a></td>
				<td width="518">&nbsp;</td>
			</tr>
	</table>
	<table width="792" border="0" cellspacing="0" cellpadding="0" style="margin:0px;">
		<tr>
			...
			<td height="28" width="100" align="center" bgcolor="#e8f5fb"><strong>货物真实性评分</strong></td>
			<td height="28" width="100" align="center" bgcolor="#e8f5fb"><strong>发货及时性评分</strong></td>
			<td height="28" width="192" align="center" bgcolor="#e8f5fb"><strong>服务态度评分</strong></td>
        </tr>
       ...
       %>        
        <tr bgcolor="<%=i%2==0?"":"#e8f5fb" %>">
			...
			<td height="28" align="center"><%=m.get("productReal") %></td>	
			<td height="28" align="center"><%=m.get("delivery") %></td>
			<td height="28" align="center"><%=m.get("communication") %></td>				
        </tr>
        <% } %>
