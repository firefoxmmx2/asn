...
<body>
	...
	<br>
	<s:form action="/do/info/createPurchaseInfo" method="post" enctype="multipart/form-data" id="form1">
		<table width="90%" align="center" cellpadding="0" cellspacing="0">
				<tr>
            		<td height="30" class="wz_left" ><span style="color:red;">*</span>求购信息标题：</td>
                	<td><input type="text" name="purchaseInfo.title" size="38"></input><span id="errorsDiv_purchaseInfo.title"></span></td>
            	</tr>	
            	<tr>
            		<td height="30" class="wz_left"><span style="color:red;">*</span>信息分类：</td>
                	<td><input type="text" name="typeName" size="38" disabled="disabled" id="typeName"/><input type="button" value="选择" onclick="onOpen()" /><input type="text" name="purchaseInfo.typeName" id="purchaseInfo.typeName" style="display: none;"/><input type="text" name="purchaseInfo.type" style="display: none;"/><span id="errorsDiv_purchaseInfo.type"></span></td>
            	</tr>
            	<tr>
            	...
            	<tr>
                	...
                	<td>
                	<textarea name="purchaseInfo.detail" rows="15" cols="60" id="detail"></textarea>
            	...
            	<tr>
            		...
            		<td><input type="text" name="purchaseInfo.keyWord" size="38" id="keyword"></input><input type="button" value="自动抽取" onclick="getKeyword();" />
            	...
            	<tr>
                	...
                	<td>
                	<label><input type="radio" name="purchaseInfo.infoValidity" value="10" class="frmrd"></input>10天</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="20" class="frmrd"></input>20天</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="30" class="frmrd"></input>1个月</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="90" checked="checked" class="frmrd"></input>3个月</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="180" class="frmrd"></input>6个月</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="360" class="frmrd"></input>12个月</label>
					<label><input type="radio" name="purchaseInfo.infoValidity" value="3600" class="frmrd"></input>长期</label>
