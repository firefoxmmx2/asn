...
<html>
	...
	<table align="center" width="790" height="45" bgcolor="#fffced" cellpadding="0" cellspacing="0"  class="sm-ts">
		...
		<s:form action="searchPurchaseInfoListOn">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
                  ...
                  <tr>
				    <td colspan="7" height="100" class="wz-18b"><img src="../../image/hzx/tous1.gif" /><span>您现在没有发布任何求购信息！</span></td>
				  </tr>
                  </s:if>
		</table>
		...
		<div>
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" class="list" >
				...
				<tr>
					...
					&nbsp;&nbsp;<input type="button" value="取消发布" class="button5" onclick="submitSelectBox('setPurchaseInfoOff?infoIds=')"></input>
					</td>
					<td colspan="5"></td>
				</tr>
			</table>
		...
		<div align="right" width="98%">
			<s:form action="toPurchaseInfoListOn">
