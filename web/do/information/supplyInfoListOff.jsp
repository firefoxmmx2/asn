...
<html>
	...
	<table align="center" width="790" height="45" bgcolor="#fffced" cellpadding="0" cellspacing="0"  class="sm-ts">
		...
		<s:form action="searchSupplyInfoListOff">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
            ...
            <tr>
			<td colspan="7" height="100" class="wz-18b"><img src="../../image/hzx/tous1.gif" /><span>您现在没有未发布的供应信息！</span></td>
			</tr>
            </s:if>
		</table>
		...
		<div align="right" width="98%">
			<s:form action="toSupplyInfoListOff">
