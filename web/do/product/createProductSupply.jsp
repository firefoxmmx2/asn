...
$(document).ready(function(){
	...
	facadeEditor.init("productSupply.productType", "facade", "productSupply.facade");
	// 初始化产品描述编辑器
...
<body>
	...
	<tr><td class="daohang" width="98%">发布供应信息</td></tr>
	</table>
	<br>
	<s:form action="/do/product/createProductSupply" method="post" enctype="multipart/form-data" id="form1">
		<table width="90%" align="center" cellpadding="10" cellspacing="0">
			<tr>
                ...
                <td width="300"><input type="text" name="productSupply.supplyTitle" size="50"></input><span id="errorsDiv_productSupply.supplyTitle"></span></td>
            </tr>
            <tr>
            	<td height="30" class="wz_left" ><span style="color:red;">*</span>产品名称：</td>
                <td><input type="text" name="productSupply.productName"></input><span id="errorsDiv_productSupply.productName"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="productType" disabled="disabled" size="38"/><input type="button" value="选择" onclick="onOpen()" /><input type="text" name="productSupply.productType" style="display: none;"/><span id="errorsDiv_productSupply.productType"></span></td>
            </tr>
                     
            <tr>
            	<td><input type="hidden" name="productSupply.facade"></input></td>
            	 <td>
            	 	<div id="facade"></div>
            	 </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                <input type="text" name="productSupply.price" size="8"></input>元<span id="errorsDiv_productSupply.price"></span>
                <span style="color:red;">*</span>计价单位:<input type="text" name="productSupply.priceUnit" size="2"></input>
            ...
            <tr>
                ...
                <td>
                <input type="text" name="productSupply.startOrder" size="8"></input><span id="errorsDiv_productSupply.startOrder"></span>
                <span style="color:red;">*</span>单位:<input type="text" name="productSupply.startOrderUnit" size="2"></input>
            ...
            <tr>
                ...
                <td>
                <input type="text" name="productSupply.maxSupply" size="8"></input><span id="errorsDiv_productSupply.maxSupply"></span>
                <span style="color:red;">*</span>单位:<input type="text" name="productSupply.maxSupplyUnit" size="2"></input>
            ...
            <tr>
                ...
                <td>
                	<textarea name="productSupply.productDetail" rows="15" cols="40"></textarea>
            ...
            <tr>
                ...
                <td>
                <textarea name="productSupply.wholeSaleDetail" rows="7" cols="40"></textarea>
            ...
            <tr>
                ...
                <td>
                <textarea name="productSupply.transportDetail" rows="7" cols="40"></textarea>
            ...
            <tr>
                ...
                <td>
                <label><input type="checkbox" name="productSupply.tradeType" value="0" class="frmrd"></input>支付宝</label>
				<label><input type="checkbox" name="productSupply.tradeType" value="1" class="frmrd"></input>银行汇款</label>
				<span id="errorsDiv_productSupply.tradeType"></span></td>
            </tr>
            <tr>
            	<td height="30" class="wz_left"><span style="color:red;">*</span>信息有效期：</td>
                <td>
                <label><input type="radio" name="productSupply.infoValidity" value="10" class="frmrd"></input>10天</label>
				<label><input type="radio" name="productSupply.infoValidity" value="20" class="frmrd"></input>20天</label>
				<label><input type="radio" name="productSupply.infoValidity" value="30" class="frmrd"></input>1个月</label>
				<label><input type="radio" name="productSupply.infoValidity" value="90" checked="checked" class="frmrd"></input>3个月</label>
				<label><input type="radio" name="productSupply.infoValidity" value="180" class="frmrd"></input>6个月</label>
				<label><input type="radio" name="productSupply.infoValidity" value="360" class="frmrd"></input>12个月</label>
				<label><input type="radio" name="productSupply.infoValidity" value="3600" class="frmrd"></input>长期</label>
