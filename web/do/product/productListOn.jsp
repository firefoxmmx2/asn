...
<html>
	...
	<table align="center" width="790" height="45" bgcolor="#fffced" cellpadding="0" cellspacing="0"  class="sm-ts">
		...
		<s:form action="searchProductListOn">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 5px;">
		<tr>
			<td nowrap width="70px" align="right">商品编号：</td>
			<td width="30"><input type="text" name="searchNumber" size="20"></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
                   <tr>
                      ...
                      <td width="116"  align="center" valign="middle" background="../../image/hzx/change2.gif" class="color_g">已上架销售的商品</td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
                      <td width="116" align="center" valign="middle" background="../../image/hzx/change1.gif" class="color_g2"><a href="#" onclick="javascript:productOff();">未上架的商品</a></td>
					  <td width="6" background="../../image/hzx/change_bg.gif"></td>
                      <td width="526" background="../../image/hzx/change_bg.gif">&nbsp;</td>
                  </tr>
                  <s:if test="listP.size()<1">
                  <tr>
				    <td colspan="7" height="100" class="wz-18b"><img src="../../image/hzx/tous1.gif" /><span>您现在没有商品上架！</span></td>
				  </tr>
                  </s:if>
		</table>
		...
		<div>
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" class="list" >
				...
				<tr>
					...
					&nbsp;&nbsp;<input type="button" value="下架" class="button5" onclick="submitSelectBox('setProductOff?productIds=')"></input>
					</td>
					<td colspan="4">&nbsp;</td>
				</tr>
			</table>
