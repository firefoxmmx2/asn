...
<html>
	...
	<body>
		...
		<tr><td class="daohang">供应信息管理</td></tr>
		</table>
		
		<s:form action="searchProductSupplyListOn">
		<tr>
		...
		<tr>
			<td colspan="3">
			&nbsp;<label><input type="radio" id="a" checked onclick="javascript:productOn();" class="frmrd"/>已发布上网</label>&nbsp;&nbsp;&nbsp;<label><input type="radio" id="a" onclick="javascript:productOff();" class="frmrd"/>已取消发布</label>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2"  align="center" class="list" >
				...
				<s:iterator id="item" value="listPS" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>'>
						...
						<td class="zuo"><div id="spic"><a href="${pageContext.request.contextPath}/front/displayDetailProduct?productId=<s:property value="#item.productId"/>" target="_blank"><img src='${pageContext.request.contextPath}<s:property value="#item.smallPicPath"/>'></a></div> </td>
						<td class="zuo"><a href="${pageContext.request.contextPath}/front/displayDetailProduct?productId=<s:property value="#item.productId"/>" target="_blank"><s:property value="#item.supplyTitle"></s:property></a></td>
						...
						<td class="zuo" width="60px" align="center"><s:date name="#item.productEndDate" format="yyyy-MM-dd"></s:date></td>
						<td class="zuo">&nbsp;<input type="button" value="修改" class="button2" onclick="doRedirect('toUpdateProductSupply?productId=<s:property value="#item.productId"></s:property>')"></input>&nbsp;</td>
					</tr>
				<%
				looprow ++;
				%>
				...
				<tr>
					...
					&nbsp;&nbsp;<input type="button" value="取消发布" class="button5" onclick="submitSelectBox('setProductSupplyOff?productIds=')"></input>
					</td>
					<td colspan="5"></td>
				</tr>
			</table>
		...
		<div align="right" width="98%">
			<s:form action="toProductSupplyListOn">
