			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2"  align="center" class="list" >
				...
				<s:iterator id="item" value="listPS" status="list"> 
					<tr class='<%=(looprow%2==0)?"row":"altRow"%>'>
						...
						<td class="zuo"><s:property value="#item.supplyTitle"></s:property></td>
				...
				<tr>
					...
					&nbsp;<input type="button" value="取消发布" class="button5" onclick="submitSelectBox('setProductSupplyOff?productIds=')"></input></td>
					<td colspan="5"></td>
				</tr>
			</table>
		</div>
