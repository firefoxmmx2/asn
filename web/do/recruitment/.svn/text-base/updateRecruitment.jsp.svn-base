...
<body>
	...
	<br>
	<s:form action="updateRecruitment" method="post"  theme="simple" namespace="/do/recr" id="form1">
		<input type="hidden" value="${recruitment.id}" name="recruitment.id"></input>
		<input type="hidden" value="${recruitment.belongTo}" name="recruitment.belongTo"></input>
		...
		<table width="90%" align="center" cellpadding="0" cellspacing="0">
            	...
            	<tr>
                	...
                	<td>
                		<textarea rows="8" cols="100" name="recruitment.jobDescription">${recruitment.jobDescription}</textarea>
            	...
            	<tr>
                	...
                	<td>
                		<textarea rows="8" cols="100" name="recruitment.jobRequirement">${recruitment.jobRequirement}</textarea>
            	...
            	<tr>
                	...
                	<td>
                		<textarea rows="8" cols="100" name="recruitment.promptMesg">${recruitment.promptMesg}</textarea>
                	</td>
            	</tr>
            	<tr>
            	...
            	<tr>
                 	<td height="40">&nbsp;</td>
	              	<td><input type="submit" value=" 确 定 " id="fb" />&nbsp;
	              	<s:if test="recruitment.status!=1">
	              	<input type="button" value="发布上网" onclick="JavaScript:document.getElementById('status').value='1';document.getElementById('fb').click();"/>
	              	</s:if>
	              	&nbsp;<input type="button" value=" 返 回 " id="fbs" onclick="javascript:history.back();"/>&nbsp;
	              	</td>
	        	</tr>  
		</table>	
	</s:form>
