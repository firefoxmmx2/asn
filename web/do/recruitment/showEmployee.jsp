...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr> 
          <td align="right"> 
            ...
            <table width="98%" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr>
              <s:if test="edu.studyAbroad==true">
              	  <td colspan="3">海外学习经历：有</td>
              </s:if>
              <s:else>
              	  <td colspan="3">海外学习经历：无</td>
              </s:else>
              </tr>
          ...
          <td align="right"> 
            ...
            <table width="98%" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr> 
                ...
                <s:if test="experience.studyAbroad==true">
                	     <td>海外工作经历:有</td>
                </s:if>
                <s:else>
                	     <td>海外工作经历:无</td>
        ...
        <tr> 
          <td bgcolor="#FFFBE7"><strong>个人照片</strong></td>    
        </tr>
        <tr> 
          <td align="center">       
         		<s:if test="employee.photoPath!=null">       
         			 <table width="98%" border="0" cellpadding="2" cellspacing="0" align="center">
              <tbody><tr align="center">     
                <td height="60" align="center"><img src="<%=cp%>${employee.photoPath}" height="400" width="500"></img></td>   
              </tr>
            </tbody>
           </table>
         	</s:if>
        ...
        <tr>
        	<td align="center">
        		<s:if test="employee.isUse==0">
        		<input type="button" value="添加到备选列表" onclick="JavaScript:window.location.href='setEmployeeUse?id=${employee.id}&jid=${employee.jobId}&status=1'" />
        		<input type="button" value="删除" onclick="JavaScript:window.location.href='deleteEmployee?ids=${employee.id}&jid=${employee.jobId}&status=0'" />
        		<input type="button" value="返回" onclick="window.location.href='toEmployeeList?jid=${employee.jobId}&status=0'"></input>
        		</s:if>
        		<s:else>
        		<input type="button" value="删除" onclick="JavaScript:window.location.href='deleteEmployee?ids=${employee.id}&jid=${employee.jobId}&status=1'" />
        		<input type="button" value="返回" onclick="window.location.href='toEmployeeList?jid=${employee.jobId}&status=1'"></input>
        		</s:else>
        	</td>   
        </tr>
      </tbody></table>
