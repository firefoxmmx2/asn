...
<table width="980" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
  <tr>
	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
	  <td width="6%"><img src="${pageContext.request.contextPath}/image/channel/zszy/search_48.gif" width="34" height="34" /></td>
	  <td width="13%" class="wz_search">产品搜索：</td>
        <td width="67%"><label>
          <input name="searchkey" type="text" size="62" />
        </label></td>
        <td width="14%"  align="center">
        <input type="image" src="${pageContext.request.contextPath}/image/channel/zszy/sousuo.jpg" width="83" height="23"/>
        </td>
      </tr>
    </table>
      </form>
...
<table width="980" border="0" cellspacing="0" cellpadding="0" align="center" class="nav" height="39">
  <tr>
    <td width="120" class="title"><a href="${pageContext.request.contextPath }/front/channel/zszy/home">再生资源首页</a></td>
	<td width="92" class="title"><a target="_blank" href="${pageContext.request.contextPath}/front/mall/product/cate1?type=0005">产品中心</a></td>
	...
	<td width="92" class="title"><a href="${pageContext.request.contextPath }/front/mall/info/showSupplyInfoList1?typeId=5" target="_blank">供应信息</a></td>
	<td width="92" class="title"><a href="${pageContext.request.contextPath }/front/mall/info/showPurchaseInfoList1?typeId=5" target="_blank">求购信息</a></td>
