...
#pagelist {border:4px solid #ccc; padding:10px; width:555px; font-size:12px; list-style-type:none; }
#pagelist li {width:555px; height:30px;}
...
#pagelist li a {width:530px; height:30px; display:block; line-height:30px; color:#666; text-decoration:none; cursor:hand; background:url(../../image/hzx/infoCenterList_bg.png) no-repeat 0 0;}
...
<body>
	 <div style="float: left;width:790px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
		<ul id="pagelist">
			...
			<li>
				<a href="showInfoCenter?id=<s:property value="#item.id"/>">
