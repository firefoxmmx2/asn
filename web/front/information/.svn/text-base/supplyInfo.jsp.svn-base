...
<body>
	<div style="font-size: 16px; text-align: left;font-weight: 700;background-image: url('../../image/hzx/nav96_01.gif');background-repeat:no-repeat; padding-left: 5px; height: 30px; width: 950px; margin-left: 12px;"><a style="color: #FFFFFF;" href="${pageContext.request.contextPath}/front/mall/info/showSupplyInfoList">供应信息</a></div>
	<div style="background-color: #EEE;position: relative;float: left;width: 950px; margin-left: 12px;">
		<div style="text-align: center; color: black; font-size: 16px;font-weight: 700"><s:property value="supplyInfo.title"/></div>
		<div style="position: relative; float: left; width:948px;">
		<div style="position: relative;width:600px; float: left; margin-left: 10px;">
		关键字：<font style="color: red;"><s:property value="supplyInfo.keyWord"/></font>
		</div>
		<div style="position: relative; float: left; width:300px; text-align: right;">
			<div style="position: relative;float: right;">类别：<s:property value="supplyInfo.typeName"/></div>
		</div>
		</div>
		<div style="position: relative; float: left; width:938px;margin-left: 10px;">所属地域：<s:property value="supplyInfo.area"/></div>
		<div style="position: relative; float: left; width:948px;">
			<p style="text-indent: 2em;font-size: 14px; ">
				<s:property value="supplyInfo.detail"/>
			</p>
		</div>
		<div style="position: relative; float: right; width:935px; text-align: right; margin-right: 10px;">信息有效期：<s:date name="supplyInfo.endDate" format="yyyy-MM-dd"></s:date></div>
	</div>
	<div style="position: relative; float: left; width:950px; margin-left: 12px;">
		<ul>
			<li>供应商名称：<s:property value="#request.member.fullName"/></li>
	...
	<a style="color: #FFFFFF;" target="_blank" href="${pageContext.request.contextPath}/front/mall/info/showSupplyInfoList1?type=<s:property value="supplyInfo.type"></s:property>">相关信息</a>
	</div>
	<div style="position: relative; float: left; width:950px;background-color: #ECF9E0; margin-left: 12px;">
		<s:if test="listS.size>0">
		<table style="font-size: 12px;" border="0" cellpadding="0" cellspacing="0" width="950">
			<tbody>
