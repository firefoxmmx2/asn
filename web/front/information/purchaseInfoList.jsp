...
<body>
	...
	<div style="height:25px; width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
	<img src="<%=request.getContextPath()%>/front/images/point4h.gif">
	<a style="color: red;" href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList">所有分类</a>
	</div>
	<div style="height:25px; width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
	 	<ul><s:iterator id="item" value="firstType">
	...
	<s:form action="/front/mall/info/showPurchaseInfoList" theme="simple">
	 ...
	 <div style="float: left;width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
		...
		<form action="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList" method="post" name="pageform" id="pageform">		
	 ...
	 <div style="float: left;width: 170px; height: 300px;background-image: url('../../image/hzx/advPic.jpg');">
