...
<body>
	<div style="height:25px; font-size: 16px; text-align: left;font-weight: 700;color: #FF7300; background-color: #FFFFFF;padding-left: 12px;">求购信息</div>
	 ...
	 <a href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList">所有分类</a>
	 <s:if test="#request.lastOneType!=null"><img src="<%=request.getContextPath()%>/front/images/point4h.gif">
	 <a href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList1?typeId=<s:property value="#request.lastOneType.ptid"/>"><s:property value="#request.lastOneType.pttypeName"/></a>
	 </s:if>
	 <s:if test="#request.lastTwoType!=null"><img src="<%=request.getContextPath()%>/front/images/point4h.gif">
	 <a href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList1?typeId=<s:property value="#request.lastTwoType.ptid"/>"><s:property value="#request.lastTwoType.pttypeName"/></a>
	 </s:if>
	 <img src="<%=request.getContextPath()%>/front/images/point4h.gif">
	 <a style="color: red;" href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList1?typeId=<s:property value="#request.mainType.ptid"/>"><s:property value="#request.mainType.pttypeName"/></a>
	 </div>
	 <div style="height:25px;  width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;height: 20px;">
	 	<ul><s:iterator id="item" value="secondType">
			<li style="float: left; margin-right: 10px; display:inline;"><a style="color: green;font-size: 12px; font-weight: 700;" href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList1?typeId=<s:property value="#item.ptid"></s:property>"><s:property value="#item.pttypeName"/></a></li>
			</s:iterator>
		</ul>
	 </div>
	 <s:form action="/front/mall/info/showPurchaseInfoList1" theme="simple">
	 ...
	 <div style="float: left;width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
		<s:iterator id="item" value="listP" status="list">      
				...
				<tr>
				<td width="50%" align="left"><a target="_blank" href="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfo?infoId=<s:property value="#item.infoId"/>&type=<s:property value="#item.type"/>" style="font-size: 16px; font-weight: 700;"><s:property value="#item.title"></s:property></a></td>
		...
		<form action="${pageContext.request.contextPath}/front/mall/info/showPurchaseInfoList1" method="post" name="pageform" id="pageform">		
	...
	<div style="float: left;width: 170px; height: 300px;background-image: url('../../image/hzx/advPic1.jpg')">
