...
<script type="text/javascript" src="../../js/geoloc/geoloc.js"></script>
...
<body>
	...
	<a style="color: red;" href="${pageContext.request.contextPath}/front/mall/info/showSupplyInfoList">所有分类</a>
	</div>
	...
	<s:form action="/front/mall/info/showSupplyInfoList" theme="simple">
	 ...
	 <div style="float: left;width:962px;text-align:left;padding-left:12px;background-color: #FFFFFF;">
		...
		<form action="${pageContext.request.contextPath}/front/mall/info/showSupplyInfoList" method="post" name="pageform" id="pageform">		
