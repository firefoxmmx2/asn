...
DEFAULT_MSG : '数据不正确',
REQUIRED_MSG : '请输入{1}',
ALPHABETIC_MSG : '{1}格式错误. 允许的字符: 字母',
ALPHANUMERIC_MSG : '{1}格式错误. 允许的字符: 字母和数字',
ALNUMHYPHEN_MSG : '{1}格式错误. 允许的字符: 字母数字\-_',
ALNUMHYPHENAT_MSG : '{1}格式错误. 允许的字符: 字母数字\-_@',
ALPHASPACE_MSG : '{1}格式错误. 允许的字符: 字母数字\-_和空格',
MINLENGTH_MSG : '{1}至少{2}个字符',
MAXLENGTH_MSG : '{1}最多{2}个字符',
NUMRANGE_MSG : '{1}应为{2}间的数字',
...
EQUAL_MSG : '{1}应等于{2}',
NOTEQUAL_MSG : '{1}应不同于{2}',
DATE_LT_MSG : '{1}应早于{2}',
DATE_LE_MSG : '{1}应早于或等于{2}',
EMAIL_MSG : '{1}应为有效的E-mail地址',
EMPTY_MSG : '{1}应为空'
