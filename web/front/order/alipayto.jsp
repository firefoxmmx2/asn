...
<%@page import="com.bornsoft.asn.utils.common.LinkEncrypt" %>
	...
	<%
		//request.setCharacterEncoding("UTF-8");
	        ...
	        String out_trade_no = request.getParameter("ncp_orderId"); //date.getOrderNum();//请与贵网站订单系统中的唯一订单号匹配
	        //订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
	        String subject = "重庆市农产品电子商务平台";//new String(request.getParameter("aliorder").getBytes("ISO-8859-1"),"utf-8");
	        //订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
	        String body = "重庆农产品,重庆农产品网,重庆市农产品电子商务平台,农产品电子商务平台，农产品现代流通,农产品,农副产品,C2B2B,F2C2B,农产品资源数据库,网上交易,产销对接,农超对接,电子农贸市场,进出口贸易,外贸出口推广,农博会,冷链物流,社区终端,连锁配送,绿色农产品网上商城，在线订购,网上支付,网上拍卖,网上典当,供求,产品，企业，行情,区县子站，专业社产品，林下产品,供销合作社,新网工程,农民专业合作社.";
	        	//new String(request.getParameter("alibody").getBytes("ISO-8859-1"),"utf-8");
