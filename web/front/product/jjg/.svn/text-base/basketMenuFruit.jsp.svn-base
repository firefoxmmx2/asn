...
<!--
<div style="width: 677px;height: 589px;">
<s:iterator id="item" value="basketFruit">
<div style="float: left; width: 131px;height: 190px;margin:2px;">
	...
	<div class="pricediv"><font color="#FF7300">￥<strong><s:property value="#item.price1"/></strong></font><s:property value="#item.productUnit"/></div>  
</div>
</s:iterator>   
</div>  -->
