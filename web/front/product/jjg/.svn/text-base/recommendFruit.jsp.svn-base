...
<s:iterator id="item" value="recommendFruit">
<div style="float: left; width: 131px;height: 190px;margin:2px;">
	<div style="margin-top: 30px;">
	<a href="${pageContext.request.contextPath}/front/displayDetailProduct?productId=<s:property value="#item.productId"/>" target="_blank" style="boder:1px solid #dddddd;">
	<img style="display:block; margin:auto;boder:none;" src="${pageContext.request.contextPath}<s:property value="#item.smallPicPath"/>" width="108" height="96" />
	</a>
	</div>
	<div style="text-align: center;" class="picbox">
		<a href="${pageContext.request.contextPath}/front/displayDetailProduct?productId=<s:property value="#item.productId"/>" target="_blank"><s:property value="#item.name" /></a>
	</div>
	<div class="pricediv"><font color="#FF7300">￥<strong><s:property value="#item.originalPrice"/></strong></font><s:property value="#item.unit"/></div>  
</div>
</s:iterator>  -->
...
<div class="adiv"><s:property value="#item.name" /></div>
<div class="pricediv"><font color="#FF7300">￥<strong><s:property value="#item.originalPrice"/></strong></font><s:property value="#item.unit"/></div>
</a>
</div>
	</s:iterator>								
