...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="m10">
  <tr>
						...
						<tr>
						 ...
						 <tr>
							 ...
							 <table width="100%" border="0" cellspacing="0" cellpadding="0">
						        ...
						        %>
			                        <tr>
			                          	<td><table width="100%" border="0" cellspacing="0" cellpadding="0" height="60" class="line">
			                            	<tr>
	...
	<td width="783" valign="top">
	  ...
	  <form action="${pageContext.request.contextPath}/front/mall/product/searchProduct-2" method="post" name="myform" onsubmit="return checkInfo();" id="productInfoList" style="margin: 0px;">
	  <s:hidden  name="type"/> 
      ...
      <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0" class="szwz">
		  <tr>
		    <td align="left" >
		    	<%@ include file="../productNavi/typeNavigator.jsp" %>
		    </td>
	  ...
	  <table width="100%" height="34" border="0" cellpadding="0" cellspacing="0"  class="plys">
           <tr>
             <td width="26" align="center"><img src="../../image/product/lb2.jpg" width="16" height="16" /></td>
			 <td width="26">列表</td>
			 <td width="26" align="center"><a href="#" onclick="myform.action='searchProduct-1';myform.submit();"  onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image21','','../../image/product/dt2.jpg',1)"><img src="../../image/product/dt1.jpg" name="Image21" width="16" height="16" border="0" id="Image21" /></a></td>
			 <td width="26">大图</td>
			 <td  width="220" align="right">排序：
			 <s:select list="#{'':'默认排序','asc':'价格从低到高','desc':'价格从高到低'}" name="priceOrder" onchange="myform.action='searchProduct-2';myform.submit();"></s:select>
			 ...
			 <td align="right">
			 	...
			 	<s:select  list="#{'':'所在地',
			 				...
			 				'710000':'台湾省',
			 				'810000':'香港特别行政区'
			 			}" name="areaCode" onchange="myform.action='searchProduct-2';myform.submit();">
			 	</s:select>			 	
			 	<%} %>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <%if(searchList == null || searchList.size()<=0){%>
		  	<tr>
		  		<td height="100"><table cellpadding="0" cellspacing="0">
		  				<tr>
		  ...
		  <tr>
		    <td>   
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px #e4e4e4 dashed; ">
			  <tr>
			    <td width="15%" rowspan="4" class="w80"> 
			    	...
			    	<img src="<%=request.getContextPath()%><%=pb.getProduct().getBigPicPath() %>.80x80" border="0" height="80" width="80" /></a></td>
			    <td width="43%" height="30" valign="bottom" class="cpmc2"><a href="<%=pubSvrUrl%>/front/mall/product/displayDetailProduct.action?productId=<%=pb.getProduct().getProductId() %><%=addUrla %>" target="_blank"><%=pb.getProduct().getProductName() %></a></td>
			    
			    <td width="12%" rowspan="2" class="price2" style="text-align:center;"><%=pb.getProduct().getPrice1()==null?"<font color=green>价格面议</font>":"<font style='font-size:12px;color:#999;font-weight:100;'>￥</font>"+Calculator.keepTwoDecimal(pb.getProduct().getPrice1()) %>/<%=pb.getProductUnit() %></td>
			    
			    <td width="15%" align="center" rowspan="2" style="color:#666666;"><%=pb.getArea() %></td>
			  ...
			  <tr>
			    <td style="text-align: left;line-height:20px;">商品描述：<%=pb.getProduct().getProductDetail()==null?"无":Str.splitAndFilterString(pb.getProduct().getProductDetail(),50)%> </td>
			  </tr> 
			  <tr>
			    <td>&nbsp;</td>
			    </tr>
  		...
  		<tr ><td height="50" align="right"> 
  			...
  			<form action="${pageContext.request.contextPath}/front/mall/product/searchProduct-2" method="get" name="pageform" id="pageform">	
