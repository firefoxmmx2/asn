...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="959">
  <tr>
    ...
    <td width="110" class="nav_01"><a href="./supplierShopQydt?supplierid=<%=shopId%>">企业动态</a></td>
...
<table width="959" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:8px;">
  ...
  <!--左边部分begin-->
    <td width="201" valign="top">
    	<img src="<%=appCp%>/front/shop/images/qydt494.gif">
		</td>
    <!--左边部分 end-->
    ...
    <td width="750" valign="top">
  		...
  		<tr>
    		<td height="385" valign="top" class="line_orange">
    			...
    			<br>
    			<!-- begin -->
    			<iframe src="<%=appCp%>/front/infoc/showInfoCenterListCompany?id=1"  width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" align="center"></iframe>
						<!--end -->
