...
<%
	...
	String companyName = "";	//根据SHOPID获取公司名称
...
<table width="959" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td nowrap width="68" valign="middle"><a href="http://www.aiecp.com/aiecp/72057594037927936/index.html" target="_top">返回平台首页</a></td>
  ...
  <!--左边部分-->
    <td width="201" valign="top">
      ...
      <tr>
	    ...
	    <!--
     <table width="201" height="91" border="0" cellpadding="0" cellspacing="0" style="margin-top:8px;">
  <tr>
    <td height="27" class="left_title"><span>产品搜索</span></td>
  </tr>
  <tr>
    <td height="64" class="line_orange"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="71%"><label>
          <input name="textfield" type="text" size="15" class="line_sousuo" />
        </label></td>
        <td width="29%"><img src="images/sousuo.jpg" width="36" height="19" /></td>
      </tr>
    </table></td>
  </tr>
</table>-->
...
<!--
    <table width="201" height="295" border="0" cellpadding="0" cellspacing="0" style="margin-top:8px;">
  <tr>
    <td height="27" class="left_title"><span>资质荣誉</span></td>
  </tr>
  <tr>
    <td height="268" valign="top" class="line_orange">
	 <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="rongyu">
      <tr>
        <td height="120" align="center"><img src="images/ry1.jpg" width="140" height="100" /></td>
      </tr>
      <tr>
        <td height="120" align="center"><img src="images/ry2.jpg" width="140" height="100" /></td>
      </tr>
      <tr>
        <td align="right" class="more" height="20">更多>></td>
      </tr>
    </table>
	</td>
  </tr>
...
<!--
    <table width="201" height="260" border="0" cellpadding="0" cellspacing="0" style="margin-top:8px;">
  <tr>
    <td height="27" class="left_title"><span>企业动态</span></td>
  </tr>
  <tr>
    <td height="233" valign="top" class="line_orange">
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td height="25" style="color:#FF0000;">·生猪价格下滑可能持续至１０月</td>
      </tr>
	  <tr>
        <td height="25">·猪价跌得“养殖户想哭”</td>
      </tr>
	  <tr>
        <td height="25">·20万吨尿素确保春耕用肥</td>
      </tr>
	  <tr>
        <td height="25">·米袋子菜篮子都要整旺实	</td>
      </tr>
	  <tr>
        <td height="25">·总量基本平衡　价格呈现涨势</td>
      </tr>
	  <tr>
        <td height="25">·“新重庆”需要新思路</td>
      </tr>
	  <tr>
        <td height="25">·2010年国内化肥市场值得看好</td>
      </tr>
	  <tr>
        <td height="25">·30万吨尿素确保春耕用肥</td>
      </tr>
      
     
      <tr>
        <td height="25" class="more" align="right">更多&gt;&gt;</td>
      </tr>
    </table>
    -->
    ...
    <td width="750" valign="top">
	    		...
	    		<td height="27" class="right_title">
					    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
				            <tr>
				                ...
				                <td width="65" align="center" class="more"><a href="<%=appCp%>/front/shop/supplierShopGycp?supplierid=<%=shopId%>" target="_top">更多&gt;&gt;</a></td>
				            </tr>
				        </table>
					</td>
	  </tr>
	  <tr>
	    <td height="385" valign="top" class="line_orange">
    			...
    			<!-- begin -->
    			<table  width="748" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #d3d2d2; border-top:none; line-height:24px">
					<tr>
					...
					%>
						<div class="picbox">
								<a href="${pageContext.request.contextPath}/front/mall/product/displayDetailProduct.action?productId=<%=p.getProductId() %>" target=_blank"><img src="${pageContext.request.contextPath}<%=p.getSmallPicPath() %>" width="100" height="100" /></a>
								
								<a href="${pageContext.request.contextPath}/front/mall/product/displayDetailProduct.action?productId=<%=p.getProductId() %>" target=_blank">
								<div class="adiv"><%=p.getProductName() %></div>
								<div class="pricediv"><font color="#FF7300">￥<strong><%=(p.getPrice1()==null?"":p.getPrice1())%></strong></font>元/<%=p.getProductUnit() %></div>
								</a>
							</div>
					<%
							loopval++;
    		...
    		<table width="750" height="228" border="0" cellpadding="0" cellspacing="0" style="margin-top:8px;">
  				<tr>
					...
					%>
					<div style="width:720px;float: left;border:0px solid #000000;"> 
						  			...
						  			<div class="picbox">  
					     <a href="<%=appCp%>/front/mall/product/displayDetailProduct.action?productId=<%=sp.getProductId() %>" target="_blank"> 
							<img src="<%=appCp%><%=sp.getSmallPicPath()%>" width="100" height="100" border="0">
						 </a>      
						 <a href="<%=appCp%>/front/mall/product/displayDetailProduct.action?productId=<%=sp.getProductId() %>" target="_blank">
